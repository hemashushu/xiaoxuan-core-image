...
// ---------------------
// Functions are accessed using the `function_public_index`.
// The `function_public_index` is determined by the "Function Index Section"
// in the module image, which is generated by the linker.
//
// The "Function Index Section" maps a pair `(module_index, function_public_index)`
// to `(target_module_index, target_function_internal_index)`.

// Function Public Index Mapping
// -----------------------------
// In the default implementation of the XiaoXuan Core Linker, the `function_public_index`
