...
// Data Public Index
// -----------------
// Data is accessed using the `data_public_index`.
// The `data_public_index` is determined by the "Data Index Section"
// in the module image, which is generated by the linker.
//
// The "Data Index Section" maps `(module_index, data_public_index)` to
// `(target_module_index, target_data_section_type, target_data_internal_index_in_section)`.

// Data Public Index Mapping
// -------------------------
// In the default implementation of the XiaoXuan Core Linker, the `data_public_index`
// is calculated using the following formula:
//
// `data_public_index = (number of all imported data) + mixed_data_internal_index`
//
// Here, the imported data includes:
// - Imported read-only data
// - Imported read-write data
// - Imported uninitialized data
//
// The `mixed_data_internal_index` combines:
// - Internal read-only data
// - Internal read-write data
// - Internal uninitialized data
//
// The diagram below illustrates the mapping process:
//
//               /-----------------------------\ <--\
